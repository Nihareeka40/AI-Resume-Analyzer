...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Mysql#31',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://github.com/" style="text-decoration: none; color: #021659;">Nihareeka Makwana</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://www.linkedin.com/in/nihareeka-makwana-488412263" style="text-decoration: none; color: grey;">Nihareeka Makwana</a> 
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Nihareeka ! Total %d " % values + " User's Have Used Our Tool : )")                
